...
#define STATUS_SUCCESS(Status) ((NTSTATUS)(Status) >= 0)
	...
	__out_opt	PULONG ReturnLength)
{
	...
	if (SystemProcessInformation == SystemInformationClass && status >= 0)
	{
...
bool __stdcall DllMain(HINSTANCE hInstance,
	...
	case DLL_PROCESS_ATTACH: {
		MessageBox(0, L"Basarili", L"Basarili", 0);
		StartHook();
		break;
	}
	default:
